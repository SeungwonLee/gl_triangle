...
class StackBlurRenderer(private val context: Context) : GLSurfaceView.Renderer {
...
//        GLES20.glViewport(0, 0, width, height)
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        GLES20.glUniform1f(blurSizeHandle, BLUR_RATIO)
    }
    ...
    companion object {
        ...
        private const val BLUR_OFFSET = 0.003f//1.3846153846f//1.3846153846f//0.003155048076953f
    }
}
